...
import modelo.PeriodicalTitle;

/**
 *
 * @author alos
 */
public class PeriodicalTitleDescriptor extends Descriptor{
    ...
    public DescriptorAnswer runRules(String aString) {
        ...
        PeriodicalTitle periodicalTitle = new PeriodicalTitle(aString);
        resp.setObject(periodicalTitle);
        return resp;
    }//de run rules
